/**
 * ============================================================
 * ResponseLink OS™ — Login Page (Local Auth Mode)
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <div className="text-center">
            <h1 className="font-display font-bold text-white text-xl">ResponseLink OS™</h1>
            <p className="text-slate-500 text-xs tracking-widest uppercase mt-0.5">AI-Assisted Community Welfare & Mobile Response Platform</p>
          </div>
        </div>
